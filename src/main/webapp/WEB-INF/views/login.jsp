            ...
            <form class="form-horizontal">
                ...
                <div class="form-group">
                    <div class="col-md-offset-4 col-md-8">
                        <button type="button" id="login" class="btn btn-default btn-primary btn-block">登录</button>
                    </div>
                </div>
            </form>
        </div>
...
<script type="text/javascript">
    $(function(){
        $("#login").click(function(){
            $.get(
                "${Project_Path}/user/login",
                $("form").serialize(),
                function (data) {
                    if (data.code == 200) {
                        //绘制前先清除数据
                        clear();
                        $(".userIdError").append(data.result.userIdOrPasswordError);
